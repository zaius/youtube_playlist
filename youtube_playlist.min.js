...
position:"fixed",left:0,top:0,width:"100%",height:"100%","z-index":1E3},onclick:g}),j=b("<div />",{id:"player_box",css:{position:"fixed",left:"50%",top:"50%",width:320,height:240,"margin-left":-160,"margin-top":-120,"z-index":1001}}),k=b("<div />",{id:"playlist_player"}),l=b("<a />",{href:"javascript:;",text:"previous",css:{"float":"left"},onclick:function(){a--;if(a<0)a+=c.length;h()}}),m=b("<a />",{href:"javascript:;",text:"next",css:{"float":"right"},onclick:function(){f();h()}});j.append(k).append(l).append(m);
